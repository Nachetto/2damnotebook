...
function getInfo(button) {
    ...
    fetch(`https://informatica.wompwomp.com/marcas/patients/${patientId}/medRecords`)
    .then(response => {
        if (!response.ok) {
...
function deleteApp(button) {
    ...
    fetch(`https://informatica.wompwomp.com/marcas/patients/medRecords/${appId}`, {
        method: 'DELETE',
        headers: {
...
function updateMedRecord(event) {
    ...
    fetch('https://informatica.wompwomp.com/marcas/patients/medRecords', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function fillDoctorCombo(combo, callback) {
    ...
    fetch('https://informatica.wompwomp.com/marcas/doctors')
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
