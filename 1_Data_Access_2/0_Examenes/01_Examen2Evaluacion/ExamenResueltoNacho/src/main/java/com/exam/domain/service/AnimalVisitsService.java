...
import com.exam.dao.Repository.repositoriesHibernate.AnimalVisitsRepository;
...
public class AnimalVisitsService {
    ...
    private final com.exam.dao.Repository.repositoriesMongo.AnimalVisitsRepository mongoRepo;

    @Inject
    public AnimalVisitsService(VisitorService visitorService, HabitatService habitatService, AnimalVisitsRepository repository, AnimalService animalService, com.exam.dao.Repository.repositoriesMongo.AnimalVisitsRepository mongoRepo){
    ...
    public Object getVisitFromAnimalName(String name) {
        return mongoRepo.getVisitFromAnimalName(name);
    }
}
