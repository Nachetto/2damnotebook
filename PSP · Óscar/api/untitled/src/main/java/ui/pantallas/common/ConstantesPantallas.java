...
public class ConstantesPantallas {
    ...
    public static final String TITULO_APP = "The Office API";
    public static final String SELECCIONE_UNA_OPCION = "You must write something to search";
    public static final String SELECCIONE_UNA_OPCION_DE_BUSQUEDA = "Select a search option";
