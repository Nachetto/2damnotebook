...
public class AuthService {
    private final PasswordEncoder passwordHash; // Esto no hace falta, ya que se usa el password encoder de spring
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        var jwtTokenEither = jwtService.generateToken(user.getUsername(), 300); //el token de acceso caduca en 5 minutos
