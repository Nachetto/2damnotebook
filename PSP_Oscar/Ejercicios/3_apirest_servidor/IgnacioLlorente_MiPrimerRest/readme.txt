He hecho el rest de mi restaurante usando jdbc

He puesto la app en el payara del instituto con el link:
http://informatica.iesquevedo.es:2326/IgnacioLlorente_RestaurantRest-OscarApruebame/api
(tienes /customers y /orders)

He puesto variables a la coleccion del postman, link:
https://api.postman.com/collections/31109183-61b31186-22b0-4703-af91-3c2396c8c568?access_key=PMAT-01HF282XTHM9ADZKHY3YPPDK5Z


------------------------------------------------------------------------------------------------------------

       SI NO TE FUNCIONA EL LINK DE ARRIBA COPIA EL JSON DEL POSTMAN DE AQUI ABAJO QUE ES LO MISMO:
...

{
	...
	"variable": [
		{
			"key": "base_url",
			"value": "http://informatica.iesquevedo.es:2326/IgnacioLlorente_RestaurantRest-OscarApruebame/api",
			"type": "string"
		},
		{
			"key": "tipo",
