...
public class SaveRecordWithMedicationToXML {

    private final MedicalRecordsService service;

    @Inject
    public SaveRecordWithMedicationToXML(MedicalRecordsService service) {
    ...
    public void saveRecordWithMedication() {
        ...
        Either<AppError, Integer> either = service.saveXML(medicalRecordDTO);
